...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{./figures/dac_dmaInterface}
    \caption{ Step 1: DAC-DMA Interface SImulation
    \label{fig:simdacdma}}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{./figures/dacInterface}
    \caption{ Step 2: DAC Interface Simulation
    \label{fig:simdac}}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{./figures/txInterface}
    \caption{ Step 3: Transmitting Interface Simulation
    \label{fig:simtxif}}
\end{figure}
