...
manageability and power consumption, characteristics of traditional RANs.
...
development board (AD9361 chip) from Analog Devices, which is a device broadly
used in software defined radio hardwares, as known as USRPs (Universal Software
Radio Peripheral).
...
Multiple Outputs), this adaptive characteristic is attractive to C-RAN
environment.

The goals of this work is evaluate the platform as a suitable device to be used
in such dinamic environment and document every step fo the integration and
hardware/software development. The communication between FPGA and tranceiver as
