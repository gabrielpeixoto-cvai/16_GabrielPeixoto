...
(Cloud-RAN) is getting attention. This behavior comes from the potential of
cloudfication for improvement in the efficiency of resource allocation,
manageability and power consumption, challenges of traditional RANs.
...
programmable fronthaul radio interface, as known, current networks do not have
the adaptive capability needed for the C-RAN. For this work a setup of a radio
unit, composed by one FPGA (digital front-end of the radio unity) and one
...
the transceiver works in LTE and C-RAN.
...
device broadly used in software defined radio hardwares, as known as USRPs
(Universal Software Radio Peripheral).

An aspect of the transceiver that is very attractive to the C-RAN paradigm is
its reconfigurability and scalability. The hardware is capable of real-time
adjustments in the sampling frequency or operation mode from 2x2 to 4x4 MIMO
(Multiple Inputs and Multiple Outputs), which is attractive to C-RAN
environment.

The goals of this work is evaluate the platform as a suitable device to be used
in such dynamic environment and document every step of the integration and
hardware/software development. The communication between FPGA and transceiver as
long as downlink transmission shall be evaluated.
