...
Such reconfigurable and scalable needs can be fullfilled by the use of a
software-defined radio device. This work aims to evaluate the potential of a
programmable front-haul radio interface, motivated by the fact that current
networks do not have the adaptive capabilities. For this work a setup of a radio
unit, composed by one FPGA (digital front-end of the radio unit) and one
transceiver (analog front-end) connected in the FPGA board. Within this setup
various algorithms can be tested and can be evaluated in LTE scenarios because
the transceiver works in LTE frequency band.
